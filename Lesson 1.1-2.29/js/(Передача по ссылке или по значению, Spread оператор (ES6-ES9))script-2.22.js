...
// Однако с помощью функции мы можем не передать по ссылке, а полностью клонировацть объект, и уже с новым объектом взаимодействовать так как нам нужно не меняя старый
